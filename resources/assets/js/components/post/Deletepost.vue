<template id="post-delete">
  <div>
    ...
    <form v-on:submit.prevent = "deletePost">
      ...
      <router-link class="btn btn-xs btn-primary" v-bind:to="'/post'">Back</router-link>
    </form>
  </div>
</template>
...
export default {
  ...
  created: function(){
    let uri = '../post/posts/'+this.$route.params.id+'/edit';
  ...
  methods: {
    deletePost: function() {
    let uri = '../post/posts/'+this.$route.params.id;
